...
// const picklePalace  = {name: "Fried Pickles", price: 8, category: "Side"}
...
*/
console.log(createMenuItem("Fried Pickles", 8, "side"))
console.log(createMenuItem("Fried ", 8, "side"))
console.log(createMenuItem("Fried dhjeg", 8, "side"))
...
export const burger = {
  ...
  discount: function(type) {
    if(type !== "teacher" && type !== "student" && type !== "public") return 
